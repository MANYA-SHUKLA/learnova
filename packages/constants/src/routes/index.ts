...
export const APP_ROUTES = {
  ...
  INSTITUTION_TIMETABLE: '/institution/timetable',
  INSTITUTION_SETTINGS: '/institution/settings',
  ...
  FACULTY_EXAM_CREATE: '/faculty/examinations/create',
  FACULTY_EXAM_DETAIL: '/faculty/examinations/:id',
  ...
  STUDENT_EXAM_START: '/student/examinations/:id/start',
  ...
  STUDENT_ACADEMIC_STANDING: '/student/academic-standing',
