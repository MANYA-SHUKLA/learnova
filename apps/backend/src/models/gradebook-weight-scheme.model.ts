...
const gradebookWeightSchemeSchema = new Schema(
  {
    ...
    examWeight: {
      type: Number,
      default: GRADEBOOK_DEFAULTS.MIDTERM_WEIGHT + GRADEBOOK_DEFAULTS.FINAL_EXAM_WEIGHT,
      min: 0,
      max: 100,
    },
    midtermWeight: {
      type: Number,
      default: GRADEBOOK_DEFAULTS.MIDTERM_WEIGHT,
      min: 0,
      max: 100,
    },
    finalExamWeight: {
      type: Number,
      default: GRADEBOOK_DEFAULTS.FINAL_EXAM_WEIGHT,
      min: 0,
      max: 100,
    },
    projectWeight: {
    ...
    attendanceWeight: {
      type: Number,
      default: GRADEBOOK_DEFAULTS.ATTENDANCE_WEIGHT,
      min: 0,
      max: 100,
    },
    extraCreditWeight: {
      type: Number,
      default: GRADEBOOK_DEFAULTS.EXTRA_CREDIT_WEIGHT,
      min: 0,
      max: 100,
    },
    attemptPolicy: {
    ...
    scaleId: { type: String, default: null, trim: true },
