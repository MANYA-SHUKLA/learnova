...
const examSchema = new Schema(
  {
    ...
    blueprintId: { type: Schema.Types.ObjectId, ref: 'ExamBlueprint', default: null, index: true },
    templateId: { type: Schema.Types.ObjectId, ref: 'ExamTemplate', default: null },
    publishedVersionId: { type: Schema.Types.ObjectId, ref: 'ExamVersion', default: null },
    versionNumber: { type: Number, default: 0, min: 0 },
