...
/** Learnova brand palette (matches UI --primary / --primary-hover) */
const MAIL_BLUE = '#2563EB';
const MAIL_BLUE_DARK = '#1D4ED8';
const MAIL_BLUE_SOFT = '#BFDBFE';
const MAIL_BLUE_LINK = '#93C5FD';
const MAIL_PAGE_BG = '#F8FAFC';
...
<table role="presentation" cellpadding="0" cellspacing="0" border="0" style="margin:28px 0 8px;">
  <tr>
    <td align="center" bgcolor="${MAIL_BLUE}" style="border-radius:12px;">
      <a href="${safeHref}"
  ...
  const items = rows
    .map((row) => {
      const valueStyle = row.mono
        ? `font-family:ui-monospace,SFMono-Regular,Menlo,Monaco,Consolas,monospace;font-size:14px;letter-spacing:0.04em;color:${MAIL_BLUE};font-weight:600;`
  ...
  <tr>
    <td style="padding:28px 32px;background:#0f172a;border-radius:0 0 18px 18px;">
      ...
      <p style="margin:0 0 4px;font-size:13px;color:#94a3b8;">
        <a href="mailto:${MAIL_CONTACT_EMAIL}" style="color:${MAIL_BLUE_LINK};text-decoration:none;">${MAIL_CONTACT_EMAIL}</a>
        &nbsp;·&nbsp;
        <a href="tel:+91${MAIL_CONTACT_PHONE}" style="color:${MAIL_BLUE_LINK};text-decoration:none;">${MAIL_CONTACT_PHONE}</a>
      </p>
      <p style="margin:12px 0 0;font-size:12px;">
        <a href="${WHATSAPP_URL}" style="color:${MAIL_BLUE_LINK};text-decoration:none;">WhatsApp ${MAIL_CONTACT_NAME}</a>
      </p>
...
<body style="margin:0;padding:0;background:${MAIL_PAGE_BG};font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;">
  ${preheader}
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background:${MAIL_PAGE_BG};padding:32px 12px;">
    <tr>
      <td align="center">
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="max-width:560px;background:#ffffff;border-radius:18px;overflow:hidden;box-shadow:0 8px 30px rgba(37,99,235,0.12);">
          <tr>
            <td style="padding:28px 32px 20px;background:linear-gradient(135deg,${MAIL_BLUE} 0%,${MAIL_BLUE_DARK} 100%);">
              ...
              <p style="margin:6px 0 0;font-size:12px;letter-spacing:0.12em;text-transform:uppercase;color:${MAIL_BLUE_SOFT};">
                Learning platform
              </p>
            </td>
          </tr>
